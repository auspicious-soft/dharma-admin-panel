...
import VideoSlideField from "../../../components/reusableComponents/EditQuestion/VideoSlideField";
    ...
    <div className="flex flex-col gap-5 ">
      ...
      <div className="flex flex-col p-4 bg-blue-50 rounded-[20px] gap-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 flex-1 w-full">
          <Input type="text" placeholder="Name of Module" />
...
export default EditLessonsTask;
