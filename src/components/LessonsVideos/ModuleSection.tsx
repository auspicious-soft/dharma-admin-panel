  ...
  return (
    <div className="space-y-[6px]">
      ...
      <div className="flex items-center justify-between bg-light-blue rounded-lg pl-2 pr-4 py-2">
        <Link
          to={`/lessons-videos/edit-lessons-module/${module.id}`}
          className="flex-1 underline-offset-1 hover:underline"
        >
          <div className="flex items-center gap-[10px]">
            <img src={ModuleIcon} alt="Module icon" className="max-w-[32px]" />
            <div className="flex flex-col  gap-1">
              ...
              <p className="justify-start text-paragraph text-xs font-medium flex flex-wrap gap-1 ">
                {module.videos} &nbsp; Videos &nbsp; • &nbsp; {module.slides}{" "}
                &nbsp; Slides &nbsp; • &nbsp; {module.questions} Questions
              </p>
            </div>
          </div>
        </Link>
            ...
            >
              ...
              <div className="flex gap-2">
                <Button
                  onClick={() =>
                    navigate(
                      `/lessons-videos/edit-lessons-task/${module.id}/${item.id}`
                    )
                  }
                  className="rounded-lg"
                  size="icon"
